	...
	return Vue.extend({	
		template : template(function(){/*
			<div  class="content" style="margin-bottom:70px;">
				<div class="card">
					<ul class="table-view">
						<li class="table-view-cell table-view-divider">终端照片</li>
				...
				<div class="card">
					<ul class="table-view">
						<li class="table-view-cell table-view-divider">客户签字照片</li>
						<li class="table-view-cell">
							<img src="resource/images/+.png" style="width:80px;margin-bottom:10px;" @click="takephoto" />
						</li>
					</ul>
				...
				<div style="padding:10px 10px 0;background:#fff;position:fixed;bottom:0;width:100%;">
					<button class="btn btn-positive btn-block" v-if="!pending" @click="next">保存拍照信息</button>
