	...
	return Vue.extend({	
		template : template(function(){/*
			<div class="content" style="background:#fff;">
				...
				ul.ttab li.active span,
				.filterBox .filter ul li.active span{	
					background:#4AA3FD;
					color:#fff;
				}
				.filterBox .filter ul li.empty{	}
				ul.ttab li span,
				.filterBox .filter ul li span{	
					border-radius:0;
					height:39px;
					background:#fafafa;
					line-height:40px;
		...
		*/}),
		...
		methods : {
			...
			peizhijiancha : function(event){	
				...
				btn.disabled = true
				setTimeout(function(){	
					location.hash="!/warningDetail-peizhijiancha"
				}.bind(this),1000)
			},
			next : function(){	
				var btn = event.srcElement
