								...
								<tr>
									<td>
										...
										<ul>
											...
											<li><span @click="filterChgOption($event)">4K电视</span></li>
											<li><span @click="filterChgOption($event)">催装</span></li>
										</ul>
										<ul>
											<li><span @click="filterChgOption($event)">百兆</span></li>
											<li><span @click="filterChgOption($event)">高清</span></li>
											<li><span @click="filterChgOption($event)">天翼看店</span></li>
											<li></li>
										</ul>
									</td>
								</tr>
				...
				<ul class="table-view table-view-custom">
					<li style="position:relative" class="table-view-cell media" v-for="row in list" @click="detail">
						<p style="position:absolute;right:10px;top:5px;">
							...
							<span class="badge b2" v-if="$index===0">催装</span>
							<span class="badge b3" v-if="$index===1">百兆</span>
							<span class="badge b3" v-if="$index===2">高清</span>
							<span class="badge b3" v-if="$index===3">天翼看店</span>
