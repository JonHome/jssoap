	...
	return Vue.extend({	
		template : template(function(){/*
			<div  class="content" style="margin-bottom:70px;">
				...
				<ul class="table-view table-view-todoList" style="background:#fff;">
					<li class="table-view-cell" @click="chuanhao">
						<a>
							<dl>
								<dt>终端串号</dt>
								<dd>未扫描</dd>
				...
				<ul class="table-view table-view-todoList" style="background:#fff;">
					<li class="table-view-cell" @click="yanshenfuwu">
						<a>
							<dl>
								<dt>延伸服务</dt>
								<dd></dd>
		...
		*/}),
		...
		methods : {
			...
			yanshenfuwu : function(){	
				location.hash="!/installDetail-yanshenfuwu"
			},
			cailiao : function(){	
